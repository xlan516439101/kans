...
import org.kans.zxb.presenter.VipGroupPresenter;
...
@ContentView(value = R.layout.vip_group_fragment)
public class VipGroupFragment extends KFragment<VipGroupPresenter, VipGroupPresenter.Ui> implements VipGroupPresenter.Ui {
	...
	@Override
	public VipGroupPresenter createPresenter() {
		return new VipGroupPresenter();
	}

	@Override
	public VipGroupFragment getUi() {
		return this;
	}
