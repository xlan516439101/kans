...
public class ProductListFragment extends KFragment<RouductListPresenter, RouductListPresenter.Ui> implements RouductListPresenter.Ui {
	...
	@Override
	public RouductListPresenter createPresenter() {
		return new RouductListPresenter();
	}

	@Override
	public ProductListFragment getUi() {
		return this;
	}
