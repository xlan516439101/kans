...
import org.kans.zxb.presenter.VipBuyPresenter;
...
@ContentView(value = R.layout.vip_buy_fragment)
public class VipBuyFragment extends KFragment<VipBuyPresenter, VipBuyPresenter.Ui> implements VipBuyPresenter.Ui {
