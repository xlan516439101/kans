...
public class VipRemarkListFragment extends KFragment<VipRemarkListPresenter, VipRemarkListPresenter.Ui> implements VipRemarkListPresenter.Ui {
	...
	@Override
	public VipRemarkListPresenter createPresenter() {
		return new VipRemarkListPresenter();
	}

	@Override
	public VipRemarkListFragment getUi() {
		return this;
	}
