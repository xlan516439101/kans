...
@ContentView(value = R.layout.rouduct_class_fragment)
public class ProductClassFragment extends KFragment<RouductClassPresenter, RouductClassPresenter.Ui> implements RouductClassPresenter.Ui {
	...
	@Override
	public RouductClassPresenter createPresenter() {
		return new RouductClassPresenter();
	}

	@Override
	public ProductClassFragment getUi() {
		return this;
	}
