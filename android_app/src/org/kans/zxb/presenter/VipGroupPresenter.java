...
import org.kans.zxb.fragment.VipGroupFragment;
...
public class VipGroupPresenter extends KPresenter<VipGroupPresenter.Ui> implements OnScrollListener {

	private VipGroupAdapter mVipGroupAdapter;
	private Runnable notifyRun;

	public interface Ui extends KUi {
		VipGroupFragment getUi();
	...
	public class VipGroupAdapter extends BaseAdapter implements KListItemCallback {
		...
		private void initView(ItemViewHold mViewHold) {
			...
			mViewHold.delButton.setOnClickListener(VipGroupPresenter.this);
			mViewHold.editButton.setTag(mViewHold.mVipGroup);
			mViewHold.editButton.setOnClickListener(VipGroupPresenter.this);
