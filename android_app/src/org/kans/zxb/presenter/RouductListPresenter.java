...
public class RouductListPresenter extends KPresenter<RouductListPresenter.Ui> implements OnItemClickListener, OnItemLongClickListener, OnScrollListener, TextWatcher {
	...
	public class RouductListAdapter extends BaseAdapter implements KListItemCallback {
		...
		private void initView(ItemViewHold mViewHold) {
			...
			mViewHold.delButton.setOnClickListener(RouductListPresenter.this);
			mViewHold.editButton.setTag(mViewHold.mProductEntity);
			mViewHold.editButton.setOnClickListener(RouductListPresenter.this);
