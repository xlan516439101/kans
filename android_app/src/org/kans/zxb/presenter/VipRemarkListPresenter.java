...
public class VipRemarkListPresenter extends KPresenter<VipRemarkListPresenter.Ui> implements OnItemClickListener, OnItemLongClickListener, OnScrollListener, TextWatcher {
	...
	public class RouductListAdapter extends BaseAdapter implements KListItemCallback {
		...
		private void initView(ItemViewHold mViewHold) {
			...
			mViewHold.delButton.setOnClickListener(VipRemarkListPresenter.this);
			mViewHold.editButton.setTag(mViewHold.mProductEntity);
			mViewHold.editButton.setOnClickListener(VipRemarkListPresenter.this);
